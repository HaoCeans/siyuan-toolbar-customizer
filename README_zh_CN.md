...
<details>
  <summary style="font-size: 24px; font-weight: 600; padding: 6px 0; cursor: pointer; color: #ff6b35;">
    💰 激活码获取方式（限时优惠中）
  </summary>
...
- 手机端顶部工具栏出现大面积空白
- 选择图片切回思源后不再误弹出一键记事弹窗
- 空块检测无法识别思源空块
- 折叠样式设置保存后需关闭面板再打开才生效，改为自动关闭面板
- 插件重载后折叠样式丢失
- 切换文档时锁按钮图标不更新
- 功能列表补全 ⑭⑮
- 导入导出已全部包含
...
##### 1. 功能说明：
   ...
   3. 本插件的免费功能，已经占据80%，如果您仍然需要单独定制功能，请私聊作者，为您私人定制！完成后，按钮将加入工具箱。
